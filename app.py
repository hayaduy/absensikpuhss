...
MOTIVASI = [
    ...
    "Kira-kira, sapa urang nang pertama kali ikam ingat pas bangun guring tadi?, pinanya om saldos nah",
    ...
    "Sudahkah manukuni habar urang nang paling ikam tkutani kalo-kalo kaganangan?",
    "Apa kabaikan sidin nang paling maulah ikam marasa 'bauntungnya ih ulun baisi pian'?",
